...
const accordionData = [
  {
    title: "ভূমিকা",
    content:
      "জনাব তারেক রহমান বাংলাদেশ জাতীয়তাবাদী দল (বিএনপি)-এর একজন প্রভাবশালী রাজনৈতিক নেতা, দূরদর্শী রাষ্ট্রনায়ক এবং আধুনিক গণতান্ত্রিক রাজনীতির অন্যতম রূপকার। সততা, কৌশলী নেতৃত্ব ও সাংগঠনিক দক্ষতার জন্য তিনি দেশের রাজনৈতিক অঙ্গনে সুপরিচিত। শহীদ রাষ্ট্রপতি জিয়াউর রহমানের আদর্শে অনুপ্রাণিত হয়ে এবং গণতন্ত্র ও জনগণের অধিকারকে সর্বোচ্চ গুরুত্ব দিয়ে তিনি দীর্ঘদিন ধরে রাজনৈতিক সংগ্রামে সক্রিয় ভূমিকা পালন করে আসছেন। তাঁর নেতৃত্বে বাংলাদেশে গণতন্ত্র পুনঃপ্রতিষ্ঠা, সুশাসন নিশ্চিতকরণ এবং মানুষের ভোটাধিকার পুনরুদ্ধারের লক্ষ্যে বিএনপি একটি সুস্পষ্ট ও সংগঠিত পথরেখা অনুসরণ করছে।",
    color: "bg-red-600",
  },
  {
    title: "জন্ম ও পারিবারিক পরিচিতি",
    content:
      "তারেক রহমান ২০ নভেম্বর ১৯৬৫ সালে জন্মগ্রহণ করেন। তিনি শহীদ রাষ্ট্রপতি জিয়াউর রহমান ও সাবেক প্রধানমন্ত্রী বেগম খালেদা জিয়ার জ্যেষ্ঠ পুত্র। একটি রাজনৈতিক ও দেশপ্রেমিক পরিবারে বেড়ে ওঠার ফলে ছোটবেলা থেকেই তিনি জাতীয় রাজনীতি, গণতন্ত্র ও জনগণের অধিকার বিষয়ে সচেতন হয়ে ওঠেন। এই পারিবারিক ঐতিহ্যই তার রাজনৈতিক চিন্তা ও নেতৃত্বের ভিত্তি গড়ে দেয়।",
    color: "bg-green-600",
  },
];
...
const milestones = [
  { year: "১৯৬৫", event: "জন্ম ও শৈশব" },
  { year: "১৯৮৮", event: "রাজনীতিতে আনুষ্ঠানিক প্রবেশ" },
  { year: "১৯৯১", event: "রাজনৈতিক নেতৃত্বে উত্থান" },
  { year: "২০০৮", event: "প্রবাসে থেকে দলের নেতৃত্ব" },
  { year: "২০২৫", event: "বাংলাদেশে প্রত্যাবর্তন ও নতুন রাজনৈতিক অধ্যায়" },
  { year: "২০২৬", event: "ঢাকা-১৭ সংসদীয় আসনে প্রতিদ্বন্দ্বিতা" },
];
